...
import { getSpec, detectMethod } from "../../utils/openApiSpec.js";
...
export const description = "Execute any GitLab API operation. Specify the spec path (e.g. /api/v4/projects) and optional path params, query params, or body. HTTP method is auto-detected. Use gitlab-api-schema to discover available paths.";
...
export async function handler(input) {
    ...
    try {
        ...
        if (!specPathEntry) {
            return ResponseFormatter.error("Path not found", `'${path}' not found in OpenAPI spec. Use gitlab-api-schema to discover available paths.`);
        }
